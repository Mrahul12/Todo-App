...
const Form = () => {
  ...
  return (
    <>
      <header className="h-[100vh] flex flex-col px-6 py-5 gap-5 overflow-hiddenl">
      <h1
          className="text-center bg-white  rounded-[5px] p-2 text-2xl font-semibold shadow-[0px_0px_6px]  text-teal-700 flex gap-4 flex-wrap justify-center items-center whitespace-nowrap leading-6"
        >
          Mini Todo  Application
          <a href="https://github.com/Mrahul12" className="bg-white text-emerald-600 shadow-[0px_0px_3px] px-2 py-1 rounded text-2xl hover:text-slate-500"><BsGithub/></a>
        </h1>
        <form
